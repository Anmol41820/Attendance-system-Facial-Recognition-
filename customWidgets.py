...
class LabeledEntry(LabelFrame):
	...
	def __init__(self,master,lbltext,err_msg,imglcn=None,*args,**kwargs):
		...
		self.entry = Entry(self,bd=0,width=32,font=('',12),textvariable=self.Entry_var,bg='#2bc878')
...
class LoginPage(Frame):
	def __init__(self,parent,*args,**kwargs):
		...
		self.master.title('Login To Attendance System')

		#icons used
		# bg=Image.open(r"g898.jpg")
        # bg=bg.resize((450,700),Image.ANTIALIAS) #resise and convert high level img to low level img
        # self.photoimg4=ImageTk.PhotoImage(img4)

		self.bg=PhotoImage(file=r'image\g898.png')
		self.intr=PhotoImage(file=r'image\internet.png')
		self.wa=PhotoImage(file=r'image\whatsapp.png')
		self.fb=PhotoImage(file=r'image\facebook.png')

		#main background image
		Label(self,image=self.bg).pack()

		#take id input and password
		self._id  = LabeledEntry(self,'Your first name here.','',r'image\users.png',**{'bg':'#2bc87c'})
		self._id.place(x=20,y=300)

		self.psw  = LabeledEntry(self,'Password','',r'image\users.png',**{'bg':'#2bc87c'})
		self.psw.entry['show']='*' # hiide typing charcters
		self.psw.place(x=20,y=390)
		#show password
		self.psw.entry.bind("<Button-3>",showPassword)
		#on release
		self.psw.entry.bind("<ButtonRelease-3>",hidePassword)
		#login butto
		self.login_btn=Button(self,text='Login',font=('arial',22),width=8,fg='#2bc87c',bg='#020e52',activebackground='#020e52',bd=0)
		self.login_btn.place(x=1,y=480)

		
		#register button
		self.register_btn=Button(self,text='Register',font=('arial',22),width=8,fg='#2bc87c',bg='#020e52',activebackground='#020e52',bd=0)
		self.register_btn.place(x=240,y=562)

		
		Label(self,text='Designed and developed by Anmol Gupta',bg='#2bc87c',font=('arial',13)).place(x=3,y=660)
...
class RegisterPage(Frame):
	def __init__(self,parent,*args,**kwargs):
		Frame.__init__(self,parent,*args,**kwargs)
		#change title
		self.master.title('Login To Attendance')
		#icons used
		self.bg=PhotoImage(file=r'image\g898.png')
		self.intr=PhotoImage(file=r'image\internet.png')
		self.wa=PhotoImage(file=r'image\whatsapp.png')
		...
		#take id input and password
		default={'bg':'#2bc87c'}
		self.fname  = LabeledEntry(self,'First name','',r'image\users.png',**default)
		#lower the width of entry
		self.fname.entry['width']=12
		self.fname.place(x=20,y=300)

		self.lanme  = LabeledEntry(self,'Last name','',r'image\users.png',**default)
		#lower the width of entry
		self.lanme.entry['width']=12
		self.lanme.place(x=200,y=300)


		self.psw  = LabeledEntry(self,'Password','',r'image\users.png',**default)
		#lower the width of entry
		self.psw.entry.config(width=12,show='*')
		self.psw.place(x=20,y=390)

		self.retype_psw  = LabeledEntry(self,'Retype password','',r'image\users.png',**default)
		#lower the width of entry
		self.retype_psw.entry.config(width=12,show='*')
		self.retype_psw.place(x=200,y=390)
		...
		#login butto
		self.register_btn=Button(self,text='Register',font=('arial',22),width=8,fg='#2bc87c',bg='#020e52',
								activebackground='#020e52',bd=0)
		self.register_btn.place(x=1,y=480)
		#register btn
		self.login_btn=Button(self,text='Login',font=('arial',22),width=8,fg='#2bc87c',bg='#020e52',
									activebackground='#020e52',bd=0)
		self.login_btn.place(x=240,y=560)
