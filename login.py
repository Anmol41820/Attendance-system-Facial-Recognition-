...
class mainApp(Tk):
	def __init__(self):
		...
		# self.geometry('+350+0')
		self.geometry("380x700+500+0")  #geometry of the window
		self.wm_iconbitmap("face.ico")
...
def next_data(self):
    self.new_window=Toplevel(self) #new window to on the top of old window
    self.app=Intro1(self.new_window)  
# run
